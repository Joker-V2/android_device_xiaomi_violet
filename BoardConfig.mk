...
BOARD_SUPER_PARTITION_GROUPS := violet_dynpart
BOARD_VIOLET_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_VIOLET_DYNPART_PARTITION_LIST := odm product system system_ext vendor
